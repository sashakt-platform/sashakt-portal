...
<Sidebar.Provider>
	<AppSidebar {data} />
	<Sidebar.Trigger
		class="text-primary fixed top-1/2 left-0 z-20 hidden size-9 -translate-y-1/2 rounded-r-md border border-l-0 border-border bg-card shadow-sm peer-data-[state=collapsed]:flex hover:bg-background"
	/>
