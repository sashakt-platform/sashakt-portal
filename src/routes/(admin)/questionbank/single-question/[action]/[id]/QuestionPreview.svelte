...
>
	...
	<Dialog.Content
		class="flex max-h-[90vh] w-[95vw] max-w-4xl flex-col items-start gap-6 rounded-xl bg-accent p-8 shadow-2xl sm:w-[90vw]"
	>
		<h2 class="text-xl font-bold text-gray-800">Preview</h2>

		<div
			class="w-full overflow-y-auto rounded-xl border border-secondary bg-white p-6 shadow-md sm:p-8"
		>
